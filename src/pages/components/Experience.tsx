...
export default function Experience() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex min-h-screen max-w-contentContainer flex-col content-center gap-4 py-10 md:px-6 mdl:pl-28 mdl:pr-16 lg:pr-12 lgl:gap-8 xl:pl-52">
        ...
        <div className="mb-10 mt-10 flex w-full flex-col mdl:flex-row">
          <div className="w-full mdl:w-1/5">
            <ul className="flex w-full flex-row overflow-x-scroll scrollbar-thin scrollbar-thumb-gray-600 mdl:flex-col mdl:overflow-hidden">
              <motion.li
          ...
          <div className="w-full mdl:w-4/5">
            <motion.div
